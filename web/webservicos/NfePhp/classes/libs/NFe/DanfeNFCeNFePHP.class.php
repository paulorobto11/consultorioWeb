...
//classes utilizadas
//classes utilizadas
require_once PATH_ROOT.'webservices/NFePhp/classes/libs/External/mpdf/mpdf.php';
require_once PATH_ROOT.'webservices/NFePhp/classes/libs/External/qrcode/qrcode.class.php';
...
class DanfeNFCeNFePHP extends CommonNFePHP implements DocumentoNFePHP
{
    ...
    public function montaDANFE($detalhes = false)
    {
        ...
        $this->html .= "<table width=\"100%\">\n";
        $this->html .= "<tr>\n";
        $this->html .= "<td  colspan=\"3\">Consulte pela Chave de Acesso em 2222<a href=\"$urlChave\" >".
            "$urlChave</a></td>\n";
        $this->html .= "</tr>\n";
        $this->html .= "<tr>\n";
