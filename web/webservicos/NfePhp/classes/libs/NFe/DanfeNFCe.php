...
class DanfeNFCeNFePHP extends CommonNFePHP implements DocumentoNFePHP
{
    ...
    public function montaDANFE($detalhes = false)
    {
        ...
        $impHtml .= "<tr>\n";
        $impHtml .= "<td align=\"left\">".utf8_encode('VALOR PRODUTOS/SERVIÇOS')."</td>\n";
        ...
        $this->html .= "<td colspan=\"3\" class=\"menor\">".
                utf8_encode("DANFE NFC-E Nota Fiscal Eletrônica para Consumidor Final")."</td>\n";
        $this->html .= "</tr>\n";
        if ($tpAmb == 1) {
            $this->html .= "<tr>\n";
            $this->html .= "<td colspan=\"3\" class=\"menor\"><b>".
                    utf8_encode("NFC-e não permite aproveitamento de crédito de ICMS")."<b></td>\n";
            $this->html .= "</tr>\n";
        } else {
            $this->html .= "<tr>\n";
        ...
        $this->html .= "<tr>\n";
        $this->html .= "<td align=\"left\">".utf8_encode('Informação dos Tributos Incidentes')."<br>(Lei Federal 12.741/2012) </td>\n";
        ...
        $this->html .= "<td>".utf8_encode('Série:')." $serieNF</td>\n";
        ...
        $this->html .= "<table width=\"100%\">\n";
        $this->html .= "<tr>\n";
        $this->html .= "<td>Prot. ".utf8_encode('Autorização')." $nProt - ".date('d/m/Y H:i:s', $tsProt)."</td>\n";
        $this->html .= "</tr>\n";
        $this->html .= "</table>\n";
    ...
    protected function itens($det)
    {
        ...
        $itensHtml .= "<tr>\n";
        $itensHtml .= "<td>#</td>\n";
        $itensHtml .= "<td>".utf8_encode('CÓDIGO')."</td>\n";
        $itensHtml .= "<td>".utf8_encode('DESCRIÇÃO')."</td>\n";
