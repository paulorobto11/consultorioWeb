...
if (!defined('PATH_ROOT')) {
    define('PATH_ROOT', 'http://localhost/sysvenda/webservices/NFePhp');
}

require_once PATH_ROOT.'webservices/NfePhp/classes/libs/Common/CommonNFePHP.class.php';
require_once PATH_ROOT.'webservices/NfePhp/classes/libs/Common/DomDocumentNFePHP.class.php';
require_once PATH_ROOT.'webservices/NfePhp/classes/libs/Common/ExceptionNFePHP.class.php';
...
class ToolsNFePHP extends CommonNFePHP
{
    ...
    public function __construct($aConfig = '', $mododebug = 2, $exceptions = false)
    {
       ...
       // echo "<hr>cert ".$this->raizDir;
       // echo "<hr>cert ".$this->certsDir;
    ...
    protected function pLoadSEFAZ($tpAmb = '', $sUF = '')
    {
        try {
            ...
            if (!isset($this->aliaslist[$sUF])) {
            	echo "<hr>RRRR ".$this->aliaslist[$sUF];
